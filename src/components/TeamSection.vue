...
<template>
    <section>
        <!-- immagini cerchi da mettere ai lati -->

        <img class="ms_shape-sx background-element" src="/shape.png" alt="">


        <img class="ms_shape-dx background-element" src="/shape2.png" alt="">
